...
MushraPage.prototype = Object.create(AudioPage.prototype);
MushraPage.prototype.constructor = MushraPage;

function MushraPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler, _mushraValidator) {
  Object.getPrototypeOf(MushraPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler);
  this.isMushra = true;
  ...
  for (var i = 0; i < this.conditions.length; ++i) {
    Object.getPrototypeOf(MushraPage.prototype).addAudioFile.call(this, this.conditions[i]);
  }
...
MushraPage.prototype.init = function () {
  Object.getPrototypeOf(MushraPage.prototype).init.call(this);
  var toDisable;
  var td;
  var active; 
...
this.waveformVisualizer = new WaveformVisualizer(this.pageManager.getPageVariableName(this) + ".waveformVisualizer", tdRight, this.reference, this.pageConfig.showWaveform, this.pageConfig.enableLooping, this.mushraAudioControl);
  ...
  Object.getPrototypeOf(MushraPage.prototype).render.call(this, _parent);
};
...
MushraPage.prototype.load = function () {
  Object.getPrototypeOf(MushraPage.prototype).load.call(this);
...
MushraPage.prototype.save = function () {
  Object.getPrototypeOf(MushraPage.prototype).save.call(this);
  this.macic.unbind(); 
...
MushraPage.prototype.store = function () {
  ...
  Object.getPrototypeOf(MushraPage.prototype).store.call(this, trial, this.session.trials);
};
