...
function MushraPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _audioContext, _bufferSize, _audioFileLoader, _errorHandler, _mushraValidator) {
  Object.getPrototypeOf(MushraPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language);
  this.isMushra = true;
...
MushraPage.prototype.store = function () {
  ...
  Object.getPrototypeOf(MushraPage.prototype).store.call(this, trial);
