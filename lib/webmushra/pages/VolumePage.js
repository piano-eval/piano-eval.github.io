...
function VolumePage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _audioContext, _bufferSize, _audioFileLoader, _errorHandler) {
  Object.getPrototypeOf(VolumePage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language);
...
VolumePage.prototype.store = function() {
  Object.getPrototypeOf(VolumePage.prototype).store.call(this, this.session.participant);
};
