...
function SpatialPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _audioContext, _bufferSize, _audioFileLoader, _errorHandler) {
	Object.getPrototypeOf(SpatialPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language);
...
SpatialPage.prototype.store = function() {
  ...
  var trial_hwd = this.session.getTrial("hwd", this.pageConfig.id);
	...
	Object.getPrototypeOf(SpatialPage.prototype).store.call(this, this.session.trials[this.session.trials.length-1]);
};
