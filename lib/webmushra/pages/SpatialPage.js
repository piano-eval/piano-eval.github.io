...
SpatialPage.prototype = Object.create(AudioPage.prototype);
SpatialPage.prototype.constructor = SpatialPage;

function SpatialPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler) {
	Object.getPrototypeOf(SpatialPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler);
	...
	for (var i = 0; i < this.stimuli.length; ++i) {
		Object.getPrototypeOf(SpatialPage.prototype).addAudioFile.call(this, this.stimuli[i]);
	}
}
...
SpatialPage.prototype.init = function() {
	Object.getPrototypeOf(SpatialPage.prototype).init.call(this);
	this.initScenes();
...
SpatialPage.prototype.render = function(_id) {
	...
	_id.append(div);
	Object.getPrototypeOf(SpatialPage.prototype).render.call(this, _id);
};
...
SpatialPage.prototype.store = function() {
  ...
  var trial_hwd = this.session.getTrial("hwd", this.pageConfig.id);
	...
	Object.getPrototypeOf(SpatialPage.prototype).store.call(this, this.session.trials[this.session.trials.length-1], this.session.trials);
};

SpatialPage.prototype.load = function() {
	Object.getPrototypeOf(SpatialPage.prototype).load.call(this);
...
SpatialPage.prototype.save = function() {
	Object.getPrototypeOf(SpatialPage.prototype).save.call(this);
