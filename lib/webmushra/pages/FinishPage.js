...
function FinishPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender) {
  Object.getPrototypeOf(FinishPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender);
...
FinishPage.prototype.render = function (_parent) {
    ...
    button.bind( "click", (function(event, ui) {
      ...
      if (this.pageConfig.send || this.pageConfig.send === undefined) {
