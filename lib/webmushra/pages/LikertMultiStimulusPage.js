...
function LikertMultiStimulusPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _audioContext, _bufferSize, _audioFileLoader, _errorHandler) {
  Object.getPrototypeOf(LikertMultiStimulusPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language);
...
LikertMultiStimulusPage.prototype.load = function () {
  Object.getPrototypeOf(LikertMultiStimulusPage.prototype).load.call(this);
...
LikertMultiStimulusPage.prototype.store = function () {
  ...
  Object.getPrototypeOf(LikertMultiStimulusPage.prototype).store.call(this, trial);
