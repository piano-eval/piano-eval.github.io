...
function PairedComparisonPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _audioContext, _bufferSize, _audioFileLoader, _errorHandler, _reference, _condition) {
  Object.getPrototypeOf(PairedComparisonPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language);
...
PairedComparisonPage.prototype.store = function () {
  ...
  Object.getPrototypeOf(PairedComparisonPage.prototype).store.call(this, choice);
