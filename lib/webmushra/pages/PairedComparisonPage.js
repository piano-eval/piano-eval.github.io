...
PairedComparisonPage.prototype = Object.create(AudioPage.prototype);
PairedComparisonPage.prototype.constructor = PairedComparisonPage;

function PairedComparisonPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler, _reference, _condition) {
  Object.getPrototypeOf(PairedComparisonPage.prototype).constructor.call(this, _pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler);
  ...
  Object.getPrototypeOf(PairedComparisonPage.prototype).addAudioFile.call(this, this.reference);
  Object.getPrototypeOf(PairedComparisonPage.prototype).addAudioFile.call(this, this.condition);
...
PairedComparisonPage.prototype.init = function () {
  Object.getPrototypeOf(PairedComparisonPage.prototype).init.call(this);
...
PairedComparisonPage.prototype.render = function (_parent) {
  ...
  Object.getPrototypeOf(PairedComparisonPage.prototype).render.call(this, _parent);
...
PairedComparisonPage.prototype.load = function () {
  Object.getPrototypeOf(PairedComparisonPage.prototype).load.call(this);
...
PairedComparisonPage.prototype.save = function () {
  Object.getPrototypeOf(PairedComparisonPage.prototype).save.call(this);
  this.macic.unbind(); 
...
PairedComparisonPage.prototype.store = function () {
  ...
  Object.getPrototypeOf(PairedComparisonPage.prototype).store.call(this, choice, this.session.trials);
};
